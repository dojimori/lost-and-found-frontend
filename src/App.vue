        ...
        <ul class="menu w-full grow">
          ...
          <li>
            <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Settings">
              ...
              <ph-check-circle :size="12" class="my-1.5 inline-block size-4"></ph-check-circle>
              <span class="is-drawer-close:hidden font-bold text-lg">My Tasks</span>
            </button>
          </li>
        </ul>
      </div>
